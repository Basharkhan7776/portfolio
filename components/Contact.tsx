...
const MailIcon = dynamic(() => import('lucide-react').then(mod => mod.MailIcon), { ssr: false });
...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const chatId = process.env.NEXT_PUBLIC_TELEGRAM_BOT_CHAT_ID; // Replace with your chat ID
    const message = `
